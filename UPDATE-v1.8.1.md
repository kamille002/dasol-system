...
### 메인 대시보드: `dashboard-tabs.html` ⭐
- **탭 기반 네비게이션**: 🏠 홈 / 📢 게시판 / 💼 내 업무 / 📊 통계
- **포함 기능**:
  - 홈 탭: 회사 공지사항, 나라장터 일정정보, 관보 업데이트
  - 부서별 바로가기 (총무행정/영업팀/수질검사/먹는물)
  - 2026년 2월 달력
  - 알림 센터
- **장점**: 깔끔한 탭 구조, 모바일 최적화

### 보조 대시보드: `dashboard-final.html` 
- **원페이지 스타일**: 탭 없이 모든 정보를 한 화면에
- **용도**: 데스크탑 환경에서 전체 정보 한눈에 보기
